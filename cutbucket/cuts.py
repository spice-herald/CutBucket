...
class CutUtils(object):
    ...
    with their ssh key, as well as clone the repository using ssh protocal, not HTTP
...
### git related functions if collaborating on GitHub ###
    ...
    def dopull(self):
        ...
        if commits_off > 0:
            raise GitError(
                'Remote repository is not up to date with branch master, this may cause issues with saving. '
    ...
    def updatecuts(self):
        ...
        be loaded into the working namespace.
        ...
        if cutnames is not None:
            ...
            print(
                f'The following cuts will be loaded into the namespace of cuts.py: {cutnames}\n'
